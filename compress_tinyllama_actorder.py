...
# with safe_open(SAVE_DIR + "/model.safetensors", framework="pt", device=0) as f:
#     print(
#         f.get_tensor("model.layers.9.mlp.up_proj.weight_g_idx")
#     )
#     # for k in f.keys():
#     #     breakpoint()
#     #     print(k, f.get_tensor(k).shape)
"""
with safe_open(SAVE_DIR + "/model.safetensors", framework="pt", device=0) as f:print(f.get_tensor("model.layers.9.mlp.up_proj.weight_dummy"))
"""